...
public class InsertionSort {
	...
	/**
	 * Sorts a list of engine.particles so that the engine.particles with the highest distance
	 * from the camera are first, and the engine.particles with the shortest distance
	 * are last.
	 * 
	 * @param list
	 *            - the list of engine.particles needing sorting.
	 */
