...
public class NormalMappingShader extends ShaderProgram{
	...
	private static final String VERTEX_FILE = Primary.fileHandler.getShader("normalMapVShader");
	private static final String FRAGMENT_FILE = Primary.fileHandler.getShader("normalMapFShader");
