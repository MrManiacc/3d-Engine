...
public class FontShader extends ShaderProgram {
    ...
    private static final String VERTEX_FILE = Primary.fileHandler.getShader("fontVertex");
    private static final String FRAGMENT_FILE = Primary.fileHandler.getShader("fontFragment");
